...
public class PaletteView extends View {
    ...
    private ArrayList<DrawingInfo> backupsList;
    ...
    public static String TAG = "PaletteView";
...
//    /*----------------------*/
    ...
    public void recover(List<DrawingInfo> infos) {
        if (infos != null && infos.size() != 0) {
            if (mDrawingList != null) {
                if (mDrawingList.size() > 0) {
                    mDrawingList.clear();
                }
                mDrawingList.addAll(infos);
                reDraw();
            }
        }
    }

    public ArrayList<DrawingInfo> backups() {
        if (null == backupsList) {
        ...
        if (null != mDrawingList) {
            backupsList.addAll(mDrawingList);
        }
        return backupsList;
    }
